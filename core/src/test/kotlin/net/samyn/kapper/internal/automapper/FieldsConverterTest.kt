...
class FieldsConverterTest {
    ...
    fun `should convert all fields to column values`() {
        val fields =
            mapOf(
                "id" to Field(1, JDBCType.INTEGER, "Int", net.samyn.kapper.internal.DbFlavour.UNKNOWN),
                "name" to Field(2, JDBCType.VARCHAR, "String", net.samyn.kapper.internal.DbFlavour.UNKNOWN),
            )
    ...
    fun `should allow null values from converter`() {
        val fields =
            mapOf(
                "email" to Field(1, JDBCType.VARCHAR, "String", net.samyn.kapper.internal.DbFlavour.UNKNOWN),
            )
