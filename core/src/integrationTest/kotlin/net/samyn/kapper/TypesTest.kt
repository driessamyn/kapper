...
class TypesTest : AbstractDbTests() {
    ...
    data class TypeTest(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (t_numeric.compareTo(other.t_numeric) != 0) return false
            if (t_decimal.compareTo(other.t_decimal) != 0) return false
        ...
        override fun hashCode(): Int {
            ...
            result = 31 * result + t_numeric.stripTrailingZeros().hashCode()
            result = 31 * result + t_decimal.stripTrailingZeros().hashCode()
    ...
    private fun createTestObject() =
        TypeTest(
            ...
            t_numeric = BigDecimal("123.456"),
            t_decimal = BigDecimal("789.012"),
            t_smallint = 1,
            t_int = 123,
            t_bigint = 123456L,
            t_float = 123.45f,
