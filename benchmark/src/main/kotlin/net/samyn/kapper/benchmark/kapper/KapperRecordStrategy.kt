...
class KapperRecordStrategy : KapperBaseStrategy() {
    override fun findHeroById(
        connection: Connection,
        id: UUID,
    ): Any? {
        return connection.querySingle<SuperHeroRecord>(
    ...
    override fun find100Heroes(connection: Connection): List<Any> {
        return connection.query<SuperHeroRecord>(
    ...
    override fun findHeroBattles(
        ...
        return connection.query<SuperHeroBattleRecord>(
            """
